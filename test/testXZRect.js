...
worldedit.drawXRect(location.add(0,0,0), location.add(10,20,5), block);
worldedit.drawXRect(location.add(0,20,5), location.add(10,0,10), block);

worldedit.drawXRect(location.add(0,0,0), location.add(-10,5,20), block);
worldedit.drawXRect(location.add(0,5,20), location.add(-10,0,40), block);
...
worldedit.drawZRect(location.add(0,0,0), location.add(20,5,-10), block);
worldedit.drawZRect(location.add(20,5,0), location.add(40,0,-10), block);
